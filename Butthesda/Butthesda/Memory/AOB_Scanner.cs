...
namespace AOB_Scanner
{
    ...
    public class AOB_Scanner : MemoryScanner
    {
        ...
        public AOB_Scanner(Process process, IntPtr handle = default(IntPtr), String pattern = "")
        {
            lprocess = process;
            lpattern = pattern;
        ...
        public byte[] ConvertPattern(String pattern)
        {
        ...
        public ulong scanLogic(byte[] localModulebytes, byte[] convertedByteArray)
        {
            ulong address = 0;
